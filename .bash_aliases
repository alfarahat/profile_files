...
alias win10-kvm='rdesktop -g 1440x900 -x roadband -a 16 -0 -P -z -p ismail -u ismail 192.168.2.1 &'

alias zfs-scriptes='cd "/storage/data/dev/zfs/is-pro_appliance/2020 .7_20.04/scripts"'
...
alias showtv='sudo virsh list --all'
alias starttv='sudo virsh start ubuntu && sudo virsh list --all'
